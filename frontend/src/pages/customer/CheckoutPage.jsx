                ...
                <div className='bg-gray-200 rounded-lg'>
                    ...
                    <div className='py-5 px-10'>
                        <div className="mb-3">
                            ...
                            <div className="cursor-pointer flex items-center gap-x-2 mt-2 bg-gray-400 py-2 px-4 rounded-[4px]">
                                <AddCircleIcon />
                                <p className="uppercase text-lg">add other{"'"}s information</p>
                            </div>
                        </div>
                    </div>
                    <div className='z-[1000] w-full h-[1px] bg-black/20' />
                    ...
                    <div className="py-3 px-10">
                        ...
                        <div className="cursor-pointer flex items-center gap-x-3 mt-2 bg-gray-400 py-2 px-4 rounded-[4px]">
                            <CheckCircleOutlineIcon />
                            <p className="uppercase text-lg flex items-center gap-x-1"> <WalletIcon /> MOMO WALLET</p>
                        </div>
                        <div className="cursor-pointer flex items-center gap-x-3 mt-2 bg-gray-400 py-2 px-4 rounded-[4px]">
                            <CheckCircleIcon />
                            <p className="uppercase text-lg flex items-center gap-x-1"> <CreditCardIcon /> ATM</p>
                        </div>
                        <button className='mt-10 mb-3 uppercase font-bold text-xl text-center py-[10px] bg-blue-800 hover:bg-blue-800/90 w-full rounded-[4px] text-white'>
                            CHECKOUT
                        </button>
                    </div>
                </div>
