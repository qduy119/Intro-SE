            ...
            <div className="p-5">
                ...
                <div className="p-4">
                    <div className="bg-gray-300 rounded-[4px] flex w-full items-center mb-5 justify-between py-2 px-4">
                        ...
                        <h3 className="font-medium text-xl w-[15%] text-center text-white py-2 px-5 bg-gray-500 rounded-[4px]">Email</h3>
                        <h3 className="font-medium text-xl w-[18%] text-center text-white py-2 px-5 bg-gray-500 rounded-[4px]">Phone Number</h3>
                        <h3 className="font-medium text-xl w-[12%] text-center text-white py-2 px-5 bg-gray-500 rounded-[4px]">Role</h3>
                        <div className="w-[5%]" />
                    </div>
