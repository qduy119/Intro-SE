            ...
            <div className="p-5">
                ...
                <div className="p-4">
                    <div className="bg-gray-300 rounded-[4px] flex w-full items-center mb-5 justify-between py-2 px-4">
                        ...
                        <h3 className="font-medium text-xl w-[15%] text-center text-white py-2 px-5 bg-gray-500 rounded-[4px]">Name</h3>
                        <h3 className="font-medium text-xl w-[15%] text-center text-white py-2 px-5 bg-gray-500 rounded-[4px]">Order Date</h3>
                        <h3 className="font-medium text-xl w-[15%] text-center text-white py-2 px-5 bg-gray-500 rounded-[4px]">Total Price</h3>
                        <h3 className="font-medium text-xl w-[12%] text-center text-white py-2 px-5 bg-gray-500 rounded-[4px]">Status</h3>
                        <div className="w-[5%]" />
                    </div>
                    ...
                    <div className="flex items-center rounded-[4px] justify-between w-full bg-gray-300 p-4 mb-5">
                        ...
                        <p className="py-2 px-5 rounded-[4px] text-xs font-medium text-center text-white bg-gray-500">DUY CHUT</p>
                        <p className="py-2 px-5 rounded-[4px] text-xs font-medium text-center text-white bg-gray-500">DUY CHUT</p>
                        <p className="py-2 px-5 rounded-[4px] text-xs font-medium text-center text-white bg-gray-500">DUY CHUT</p>
                        <p className="py-2 px-5 rounded-[4px] text-xs font-medium text-center text-white bg-gray-500">DUY CHUT</p>
